...
!function () {
  if (!window.TradingView || !window.TradingView.host || window.TradingView.reoloadTvjs) {
    var e, t, i, o, n, r, s, a = {
      ...
      widget: function (e) {
        this.id = e.id || d.gId();
        var t = d.getUrlParams(), i = e.tvwidgetsymbol || t.tvwidgetsymbol || t.symbol || e.symbol || "NASDAQ:AAPL",
          o = e.logo || "";
    ...
    d.DependenciesManager = function () {
      ...
      createWidget: function () {
        ...
        var p = this.options.chartOnly ? "&chartOnly=1" : "", g = this.options.whitelabel ? "&whitelabel=1" : "",
      ...
      if (n && n.provider && "TradingView" === n.provider) if (n.source = e.source, "get" === n.type) {
        ...
        o[n.name].forEach((function (e) {
          "function" == typeof e && e.call(n, n.data, (function (e) {
            var i = {id: n.id, type: "on", name: n.name, client_id: n.client_id, data: e, provider: "TradingView"};
